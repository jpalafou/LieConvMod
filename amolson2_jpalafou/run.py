...
ax1.plot(t[dataidx, 0:T], px_pred_Trivial[dataidx].detach().numpy(), '--', label=r'Trivial predicted $p_x$')
ax1.plot(t[dataidx, 0:T], py_pred_Trivial[dataidx].detach().numpy(), '--', label=r'Trivial predicted $p_y$')
ax1.plot(t[dataidx, 0:T], px_pred_T[dataidx].detach().numpy(), '--', label=r'T2 predicted $p_x$')
ax1.plot(t[dataidx, 0:T], py_pred_T[dataidx].detach().numpy(), '--', label=r'T2 predicted $p_y$')
ax1.plot(t[dataidx, 0:T], px_pred_SO2[dataidx].detach().numpy(), '--', label=r'SO2 predicted $p_x$')
ax1.plot(t[dataidx, 0:T], py_pred_SO2[dataidx].detach().numpy(), '--', label=r'SO2 predicted $p_y$')
ax1.legend()

# angular momentum
ax2.plot(t[dataidx, 0:T], pang[dataidx, 0:T], label='dataset')
ax2.plot(t[dataidx, 0:T], pang_pred_T[dataidx].detach().numpy(), '--', label=r'T2 predicted $p_{\theta}$')
ax2.plot(t[dataidx, 0:T], pang_pred_SO2[dataidx].detach().numpy(), '--', label=r'SO2 predicted $p_{\theta}$')
ax2.set_xlabel('t')
ax2.legend()
